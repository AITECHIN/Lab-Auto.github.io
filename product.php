...
<div class="modal fade" id="insertModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <table id="table_id" class="table" id="main" >
    ...
    <tr>
      ...
      <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#insertModalCenter">
         Add New Products
      </button>
...
<div class="input-group" id="search-bar">
      ...
      <input type="text" class="form-control" style="border-color: blue;" id="search" placeholder="Search" aria-label="Username" aria-describedby="basic-addon1">
        ...
        <!-- <div class="input-group mb-2 bg-dark" id="search-bar">
        <span class="input-group-text" id="basic-addon2">Search Bar</span>
          <input class="form-control " type="text" id="search" autocomplete="off">
        </div>
      </td> -->
